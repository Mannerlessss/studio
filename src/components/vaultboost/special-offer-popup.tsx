...
export function SpecialOfferPopup() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-md bg-gradient-to-br from-card via-card to-primary/10 border-primary shadow-2xl" onInteractOutside={handleClose}>
        ...
        <DialogFooter className="sm:justify-center flex-col sm:flex-col sm:space-x-0 gap-2">
          <Link href={whatsappUrl} className="w-full" target="_blank" onClick={handleClose}>
